...
> **Implementation status:** 🟢 Sprint 2 Complete — state machine and architecture defined in `playos-spec`. No source code yet (`CONTRIBUTING.md` only). This AGENTS.md describes the **target** structure.
